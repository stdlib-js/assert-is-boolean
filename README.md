...
```javascript
import isBoolean from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-boolean@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isObject, isPrimitive } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-boolean@v0.2.0-deno/mod.js';
```
